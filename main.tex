...
\usetikzlibrary{
  ...
  mindmap, trees, timeline, matrix, chains, scopes,
  fadings, through, plotmarks, intersections, bbox
}
...
\titleformat{\section}[block]
  ...
  {\thesection}{1em}{}
  [\vspace{2pt}\color{AccentGold}\titlerule[1.5pt]]

\titleformat{\subsection}[block]
  {\large\bfseries\color{PrimaryMid}}
  {\thesubsection}{0.8em}{}
  [\vspace{1pt}\color{NeutralMid}\titlerule[0.6pt]]
...
\setlatinfont[Scale=0.95]{Linux Libertine O}
