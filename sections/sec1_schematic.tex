...
% ─── خط اصلی ─────────────────────────────────────────────────
\draw[-Stealth, thick] (-0.5,0) -- (16.5,0) node[right,font=\small\bfseries,color=PrimaryDeep] {\rl{زمان}}; % FIXED: \draw اضافه شد
...
\begin{tikzpicture}[
  ...
  lbl/.style={font=\tiny, fill=white, inner sep=2pt, rounded corners, align=center},
]
